...
from app.core.dependencies import DependAutomobileUseCase, UserCodeCredentials
...
async def get_automobile(code: int, auto_case: DependAutomobileUseCase, user_code: UserCodeCredentials):
...
async def create_automobile(automobile_request: AutomobileRequest,
                            auto_case: DependAutomobileUseCase, user_code: UserCodeCredentials):
...
async def delete_automobile(code: int, auto_case: DependAutomobileUseCase, user_code: UserCodeCredentials):
