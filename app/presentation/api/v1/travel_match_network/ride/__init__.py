...
from app.core.dependencies.database import DependCacheSession
...
async def get_current_ride_status(ride_case: DependRideCase, events: DependPassengerEventsCase,
