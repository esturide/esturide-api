...
@travel.get("/search", response_model=List[TravelScheduleResponse])
...
@travel.get("/current", response_model=TravelScheduleResponse)
...
@travel.get("/{uuid}", response_model=TravelScheduleResponse)
