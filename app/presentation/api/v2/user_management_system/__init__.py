...
from app.presentation.api.v2.user_management_system.automobile import automobile_router
from app.presentation.api.v2.user_management_system.driver import driver
from app.presentation.api.v2.user_management_system.user import user
