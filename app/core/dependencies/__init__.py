...
QueryUserCodeCredentials = Annotated[Tuple[bool, UserCode], Depends(user_code_credentials)]
UserCodeCredentials = Annotated[UserCode, Depends(get_user_is_authenticated)]
